...
public class FunctionsTest {
    ...
    public void testFunction4() {
        Functions.Function4<Integer, Integer, Integer, Integer, Integer> fn = (item1, item2, item3, item4) -> item1 + item2 + item3 - item4;
    ...
    public void testFunction5() {
        Functions.Function5<Integer, Integer, Integer, Integer, Integer, Integer> fn = (item1, item2, item3, item4, item5) -> item1 + item2 + item3 - item4 -item5;
