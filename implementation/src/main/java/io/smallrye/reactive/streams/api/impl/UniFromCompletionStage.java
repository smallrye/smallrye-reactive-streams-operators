...
public class UniFromCompletionStage<O> extends UniOperator<Void, O> {
    private final CompletionStage<? extends O> stage;

    public UniFromCompletionStage(CompletionStage<? extends O> stage) {
        super(null);
    ...
    static <O> void forwardFromCompletionStage(CompletionStage<? extends O> stage, WrapperUniSubscriber<? super O> subscriber) {
