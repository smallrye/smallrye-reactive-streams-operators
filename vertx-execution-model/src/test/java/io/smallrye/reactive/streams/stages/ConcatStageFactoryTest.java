...
/**
 * Checks the behavior of the {@link ConcatStageFactory} class, especially the thread handling when running from a Vert.x
 * context.
 *
...
public class ConcatStageFactoryTest extends StageTestBase {
    ...
    public void testConcatenationWhenAllEmissionsAreMadeFromDifferentThreadsButCreationIsOnVertxContext() {
        ...
        Callable<CompletionStage<List<Integer>>> callable = () -> ReactiveStreams
